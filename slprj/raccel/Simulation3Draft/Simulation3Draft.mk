...
MODEL                   = Simulation3Draft
MODULES                 = rt_matrx.c rt_printf.c Simulation3Draft.c Simulation3Draft_capi.c Simulation3Draft_data.c Simulation3Draft_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c raccel_sfcn_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = Simulation3Draft.exe
MAKEFILE                = Simulation3Draft.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023a
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023a
START_DIR               = C:\Users\JACKYO~1\OneDrive\DOCUME~1\GitHub\EEE309~1
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="C:\\Program Files\\MATLAB\\R2023a" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=1 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Simulation3Draft_ref.rsp
COMPILER_COMMAND_FILE     = Simulation3Draft_comp.rsp
...
raccel_sfcn_utils.obj : $(MATLAB_ROOT)\rtw\c\src\rapid\raccel_sfcn_utils.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\rtw\c\src\rapid\raccel_sfcn_utils.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\rtw\c\src\rapid\raccel_sfcn_utils.c
