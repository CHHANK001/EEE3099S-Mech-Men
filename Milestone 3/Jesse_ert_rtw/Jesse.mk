###########################################################################
## Makefile generated for component 'Jesse'. 
## 
## Makefile     : Jesse.mk
## Generated on : Wed Oct 04 16:47:05 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Jesse.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Jesse.elf
...
DEFINES_STANDARD = -DMODEL=Jesse -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o xcp_ext_mode.o Jesse.o Jesse_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : $(START_DIR)/Jesse_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Jesse_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Jesse_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Jesse_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Jesse.o : $(START_DIR)/Jesse_ert_rtw/Jesse.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Jesse_data.o : $(START_DIR)/Jesse_ert_rtw/Jesse_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Jesse_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
