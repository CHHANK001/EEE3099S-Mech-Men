...
#ifndef RTW_HEADER_Line_following_private_h_
#define RTW_HEADER_Line_following_private_h_
#include "rtwtypes.h"
...
#endif                                /* RTW_HEADER_Line_following_private_h_ */
