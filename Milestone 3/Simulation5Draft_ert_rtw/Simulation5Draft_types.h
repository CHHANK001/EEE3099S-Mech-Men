...
#ifndef RTW_HEADER_Simulation5Draft_types_h_
#define RTW_HEADER_Simulation5Draft_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"
...
typedef struct P_CoreSubsys_Simulation5Dra_l_T_ P_CoreSubsys_Simulation5Dra_l_T;

/* Parameters for system: '<S6>/Subsystem' */
typedef struct P_CoreSubsys_Simulation5Draft_T_ P_CoreSubsys_Simulation5Draft_T;

/* Parameters (default storage) */
typedef struct P_Simulation5Draft_T_ P_Simulation5Draft_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Simulation5Draft_T RT_MODEL_Simulation5Draft_T;

#endif                                /* RTW_HEADER_Simulation5Draft_types_h_ */
