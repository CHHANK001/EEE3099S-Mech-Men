###########################################################################
## Makefile generated for component 'Simulation4Draft'. 
## 
## Makefile     : Simulation4Draft.mk
## Generated on : Sat Sep 09 13:48:45 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Simulation4Draft.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Simulation4Draft.elf
...
DEFINES_STANDARD = -DMODEL=Simulation4Draft -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rt_matrx.o rt_printf.o Simulation4Draft.o Simulation4Draft_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o sfun_time.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/Simulation4Draft_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Simulation4Draft_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Simulation4Draft_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Simulation4Draft_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Simulation4Draft_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Simulation4Draft.o : $(START_DIR)/Simulation4Draft_ert_rtw/Simulation4Draft.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Simulation4Draft_data.o : $(START_DIR)/Simulation4Draft_ert_rtw/Simulation4Draft_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Simulation4Draft_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Simulation4Draft_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Simulation4Draft_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Simulation4Draft_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
