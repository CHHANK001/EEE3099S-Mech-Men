###########################################################################
## Makefile generated for component 'Drive'. 
## 
## Makefile     : Drive.mk
## Generated on : Sat Sep 09 15:25:38 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Drive.elf
...
START_DIR                 = C:/Users/JACKYO~1/OneDrive/DOCUME~1/GitHub/EEE309~1/MILEST~1/SIMULA~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Drive.elf
...
DEFINES_STANDARD = -DMODEL=Drive -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = xcp_ext_mode.o rt_matrx.o rt_printf.o Drive.o Drive_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o sfun_time.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : C:/Users/JACKYO~1/AppData/Roaming/MATHWO~1/MATLAB~1/TOOLBO~1/MOBILE~1/MOBILE~1/REALTI~1/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : C:/Users/JACKYO~1/AppData/Roaming/MATHWO~1/MATLAB~1/TOOLBO~1/MOBILE~1/MOBILE~1/REALTI~1/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : C:/Users/JACKYO~1/AppData/Roaming/MATHWO~1/MATLAB~1/TOOLBO~1/MOBILE~1/MOBILE~1/REALTI~1/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : C:/Users/JACKYO~1/AppData/Roaming/MATHWO~1/MATLAB~1/TOOLBO~1/MOBILE~1/MOBILE~1/REALTI~1/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : C:/Users/JACKYO~1/AppData/Roaming/MATHWO~1/MATLAB~1/TOOLBO~1/MOBILE~1/MOBILE~1/REALTI~1/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Drive_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Drive_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Drive_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Drive_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Drive.o : $(START_DIR)/Drive_ert_rtw/Drive.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Drive_data.o : $(START_DIR)/Drive_ert_rtw/Drive_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Drive_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Drive_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Drive_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Drive_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
sfun_time.o : C:/Users/JACKYO~1/AppData/Roaming/MATHWO~1/MATLAB~1/TOOLBO~1/MOBILE~1/MOBILE~1/REALTI~1/sfun_time.c
	$(CC) $(CFLAGS) -o "$@" "$<"
