...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } RMotorDist_PWORK;                  /* '<Root>/RMotorDist' */

  struct {
    void *LoggedData;
  } LMotorDist_PWORK;                  /* '<Root>/LMotorDist' */

  int32_T sfEvent;                     /* '<S5>/MATLAB Function' */
  uint8_T is_active_c1_mobileRoboticsTrai;/* '<S5>/MATLAB Function' */
