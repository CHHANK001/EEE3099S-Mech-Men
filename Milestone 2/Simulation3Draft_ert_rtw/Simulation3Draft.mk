###########################################################################
## Makefile generated for component 'Simulation3Draft'. 
## 
## Makefile     : Simulation3Draft.mk
## Generated on : Sat Sep 09 13:51:06 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Simulation3Draft.elf
...
PRODUCT_NAME              = Simulation3Draft
MAKEFILE                  = Simulation3Draft.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/JACKYO~1/OneDrive/DOCUME~1/GitHub/EEE309~1/MILEST~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Simulation3Draft.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=10 -DMW_PRESCALAR=128 -DMW_TIMERCOUNT=625 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=2 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL1_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Simulation3Draft -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rt_matrx.o rt_printf.o Simulation3Draft.o Simulation3Draft_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o sfun_time.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/Simulation3Draft_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Simulation3Draft_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Simulation3Draft_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Simulation3Draft_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Simulation3Draft_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Simulation3Draft.o : $(START_DIR)/Simulation3Draft_ert_rtw/Simulation3Draft.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Simulation3Draft_data.o : $(START_DIR)/Simulation3Draft_ert_rtw/Simulation3Draft_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Simulation3Draft_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Simulation3Draft_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Simulation3Draft_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Simulation3Draft_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
