...
#ifndef RTW_HEADER_Simulation3Draft_types_h_
#define RTW_HEADER_Simulation3Draft_types_h_
#include "rtwtypes.h"
...
typedef struct P_CoreSubsys_Simulation3Draft_T_ P_CoreSubsys_Simulation3Draft_T;

/* Parameters for system: '<S128>/Look up Sensor Value' */
typedef struct P_CoreSubsys_Simulation3Dr_le_T_ P_CoreSubsys_Simulation3Dr_le_T;

/* Parameters for system: '<S126>/Subsystem' */
typedef struct P_CoreSubsys_Simulation3Dra_l_T_ P_CoreSubsys_Simulation3Dra_l_T;

/* Parameters (default storage) */
typedef struct P_Simulation3Draft_T_ P_Simulation3Draft_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Simulation3Draft_T RT_MODEL_Simulation3Draft_T;

#endif                                /* RTW_HEADER_Simulation3Draft_types_h_ */
