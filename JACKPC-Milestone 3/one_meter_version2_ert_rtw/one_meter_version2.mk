###########################################################################
## Makefile generated for component 'one_meter_version2'. 
## 
## Makefile     : one_meter_version2.mk
## Generated on : Wed Oct 04 16:12:33 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/one_meter_version2.elf
...
PRODUCT_NAME              = one_meter_version2
MAKEFILE                  = one_meter_version2.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/one_meter_version2.elf
...
DEFINES_STANDARD = -DMODEL=one_meter_version2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o xcp_ext_mode.o one_meter_version2.o one_meter_version2_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : $(START_DIR)/one_meter_version2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/one_meter_version2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/one_meter_version2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/one_meter_version2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/one_meter_version2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/one_meter_version2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


one_meter_version2.o : $(START_DIR)/one_meter_version2_ert_rtw/one_meter_version2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


one_meter_version2_data.o : $(START_DIR)/one_meter_version2_ert_rtw/one_meter_version2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
