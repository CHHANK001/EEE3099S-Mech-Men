###########################################################################
## Makefile generated for component 'one_meter'. 
## 
## Makefile     : one_meter.mk
## Generated on : Mon Oct 09 16:43:03 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/one_meter.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/one_meter.elf
...
DEFINES_STANDARD = -DMODEL=one_meter -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o one_meter.o one_meter_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/one_meter_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/one_meter_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/one_meter_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/one_meter_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/one_meter_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/one_meter_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


one_meter.o : $(START_DIR)/one_meter_ert_rtw/one_meter.c
	$(CC) $(CFLAGS) -o "$@" "$<"


one_meter_data.o : $(START_DIR)/one_meter_ert_rtw/one_meter_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
