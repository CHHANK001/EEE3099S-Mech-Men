###########################################################################
## Makefile generated for component 'Rotation'. 
## 
## Makefile     : Rotation.mk
## Generated on : Thu Oct 05 16:11:51 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Rotation.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Rotation.elf
...
DEFINES_STANDARD = -DMODEL=Rotation -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o xcp_ext_mode.o Rotation.o Rotation_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : $(START_DIR)/Rotation_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Rotation_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Rotation_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Rotation_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Rotation_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Rotation.o : $(START_DIR)/Rotation_ert_rtw/Rotation.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Rotation_data.o : $(START_DIR)/Rotation_ert_rtw/Rotation_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Rotation_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
