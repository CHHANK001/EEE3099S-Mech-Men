...
#ifndef RTW_HEADER_Rotation_types_h_
#define RTW_HEADER_Rotation_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"
...
typedef struct tag_qrLkTWTW64zZK0sqwALTyG codertarget_arduinobase_blo_b_T;

#endif                             /* typedef_codertarget_arduinobase_blo_b_T */

/* Parameters (default storage) */
typedef struct P_Rotation_T_ P_Rotation_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Rotation_T RT_MODEL_Rotation_T;

#endif                                 /* RTW_HEADER_Rotation_types_h_ */
