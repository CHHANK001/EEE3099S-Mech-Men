###########################################################################
## Makefile generated for component 'Simulation5Draft'. 
## 
## Makefile     : Simulation5Draft.mk
## Generated on : Wed Oct 04 14:48:38 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Simulation5Draft.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Simulation5Draft.elf
...
DEFINES_STANDARD = -DMODEL=Simulation5Draft -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Simulation5Draft_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Simulation5Draft_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Simulation5Draft_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Simulation5Draft_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Simulation5Draft_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Simulation5Draft.o : $(START_DIR)/Simulation5Draft_ert_rtw/Simulation5Draft.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Simulation5Draft_data.o : $(START_DIR)/Simulation5Draft_ert_rtw/Simulation5Draft_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Simulation5Draft_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
