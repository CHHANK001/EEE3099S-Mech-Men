...
#ifndef RTW_HEADER_Line_following_h_
#define RTW_HEADER_Line_following_h_
#ifndef Line_following_COMMON_INCLUDES_
#define Line_following_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Line_following_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  uint8_T is_active_c1_Line_following; /* '<Root>/Line Folwing' */
  uint8_T is_c1_Line_following;        /* '<Root>/Line Folwing' */
...
struct tag_RTM_Line_following_T {
...
extern P_Line_following_T Line_following_P;

/* Block signals (default storage) */
extern B_Line_following_T Line_following_B;

/* Block states (default storage) */
extern DW_Line_following_T Line_following_DW;

/* External function called from main */
extern void Line_following_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void Line_following_initialize(void);
extern void Line_following_step0(void);
extern void Line_following_step1(void);
extern void Line_following_step2(void);
extern void Line_following_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Line_following_T *const Line_following_M;
 ...
 *
 * '<Root>' : 'Line_following'
 * '<S1>'   : 'Line_following/Line Folwing'
 * '<S2>'   : 'Line_following/To wlwr'
 */
#endif                                 /* RTW_HEADER_Line_following_h_ */
