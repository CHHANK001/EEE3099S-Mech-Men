###########################################################################
## Makefile generated for component 'LineFollowing3'. 
## 
## Makefile     : LineFollowing3.mk
## Generated on : Mon Oct 09 16:36:12 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LineFollowing3.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LineFollowing3.elf
...
DEFINES_STANDARD = -DMODEL=LineFollowing3 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_Ultrasonic.o LineFollowing3.o LineFollowing3_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/LineFollowing3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/LineFollowing3_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LineFollowing3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/LineFollowing3_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LineFollowing3_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LineFollowing3.o : $(START_DIR)/LineFollowing3_ert_rtw/LineFollowing3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LineFollowing3_data.o : $(START_DIR)/LineFollowing3_ert_rtw/LineFollowing3_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/LineFollowing3_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
